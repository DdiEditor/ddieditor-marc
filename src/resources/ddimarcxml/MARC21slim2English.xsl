...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="marc:datafield[@tag=010]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='z']">
				<li>
					Cancelled/invalid LC control number:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
		</ul>
	...
	<xsl:template match="marc:datafield[@tag=011]">
		<p>LINKING LIBRARY OF CONGRESS CONTROL NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Linking LC control number:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
		</ul>
	...
	<xsl:template match="marc:datafield[@tag=013]">
		<p>PATENT CONTROL INFORMATION</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Number:
	...
	<xsl:template match="marc:datafield[@tag=014]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='z']">
				<li>
					Cancelled/invalid linkage number:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
		</ul>
	...
	<xsl:template match="marc:datafield[@tag=015]">
		<p>NATIONAL BIBLIOGRAPHY NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=016]">
		<p>NATIONAL BIBLIOGRAPHIC AGENCY CONTROL NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='8']">
				<li>
					Field link and sequence number:
	...
	<xsl:template match="marc:datafield[@tag=017]">
		<p>COPYRIGHT REGISTRATION NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=018]">
		<p>COPYRIGHT ARTICLE-FEE CODE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=024]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='z']">
				<li>
					Cancelled/invalid standard code:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='2']">
				<li>
					Source of code or number:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='6']">
	...
	<xsl:template match="marc:datafield[@tag=025]">
		<p>OVERSEAS ACQUISITION NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=027]">
		<p>STANDARD TECHNICAL REPORT NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=028]">
		<p>PUBLISHER NUMBER FOR MUSIC</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Publisher number:
	...
	<xsl:template match="marc:datafield[@tag=032]">
		<p>POSTAL REGISTRATION NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=033]">
		<p>DATE/TIME AND PLACE OF AN EVENT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Formatted date/time:
	...
	<xsl:template match="marc:datafield[@tag=034]">
		<p>CODED CARTOGRAPHIC MATHEMATICAL DATA</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Category of scale:
			...
			<xsl:for-each select="marc:subfield[@code='j']">
				<li>
					Declination--northern limit:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='k']">
				<li>
					Declination--southern limit:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='m']">
				<li>
					Right ascension--eastern limit:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='n']">
				<li>
					Right ascension--western limit:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
	...
	<xsl:template match="marc:datafield[@tag=035]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='z']">
				<li>
					Cancelled/invalid system control number:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='6']">
	...
	<xsl:template match="marc:datafield[@tag=036]">
		<p>ORIGINAL STUDY NUMBER FOR COMPUTER DATA FILES</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=039]">
		<p>LEVEL OF BIBLIOGRAPHIC CONTROL AND CODING DETAIL</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
			...
			<xsl:for-each select="marc:subfield[@code='e']">
				<li>
					Number of fixed field character positions coded:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
		</ul>
	...
	<xsl:template match="marc:datafield[@tag=044]">
		<p>COUNTRY OF PUBLISHING/PRODUCING ENTITY CODE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=045]">
		...
		<ul>
			...
			<xsl:for-each select="marc:subfield[@code='b']">
				<li>
					Formatted 9999 B.C. through A.D. time period:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='c']">
	...
	<xsl:template match="marc:datafield[@tag=047]">
		<p>FORM OF MUSICAL COMPOSITION CODE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=048]">
		<p>NUMBER OF MUSICAL INSTRUMENTS OR VOICES CODE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=050]">
		<p>LIBRARY OF CONGRESS CALL NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
			...
			<xsl:for-each select="marc:subfield[@code='8']">
				<li>
					Field link and number sequence:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='3']">
	...
	<xsl:template match="marc:datafield[@tag=051]">
		<p>LIBRARY OF CONGRESS COPY, ISSUE, OFFPRINT STATEMENT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Classification number:
	...
	<xsl:template match="marc:datafield[@tag=055]">
		<p>CALL NUMBERS/CLASS NUMBERS ASSIGNED IN CANADA</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Classification number:
	...
	<xsl:template match="marc:datafield[@tag=058]">
		<p>OTHER GEOGRAPHIC CLASSIFICATION CODE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Geographic classification area code:
	...
	<xsl:template match="marc:datafield[@tag=060]">
		<p>NATIONAL LIBRARY OF MEDICINE CALL NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Classification number:
	...
	<xsl:template match="marc:datafield[@tag=061]">
		<p>NATIONAL LIBRARY OF MEDICINE COPY STATEMENT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Classification number:
	...
	<xsl:template match="marc:datafield[@tag=066]">
		<p>CHARACTER SETS PRESENT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Non-ASCII G0 default character set designation:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='b']">
				<li>
					Non-ANSEL G1 default character set designation:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
			<xsl:for-each select="marc:subfield[@code='c']">
				<li>
					Alternate graphic character set identification:
					<xsl:value-of select="text()"/>
				</li>
			</xsl:for-each>
		</ul>
	...
	<xsl:template match="marc:datafield[@tag=070]">
		<p>NATIONAL AGRICULTURAL LIBRARY CALL NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Classification number:
	...
	<xsl:template match="marc:datafield[@tag=071]">
		<p>NATIONAL AGRICULTURAL LIBRARY COPY STATEMENT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Classification number:
	...
	<xsl:template match="marc:datafield[@tag=073]">
		<p>TYPE OF PROGRAM OR ORGANIZATION CODE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=080]">
		<p>UNIVERSAL DECIMAL CLASSIFICATION NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=084]">
		<p>OTHER CLASSIFICATION NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Classification number:
	...
	<xsl:template match="marc:datafield[@tag=086]">
		<p>GOVERNMENT DOCUMENT CLASSIFICATION NUMBER</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Classification number:
	...
	<xsl:template match="marc:datafield[@tag=211]">
		<p>ACRONYM OR SHORTENED TITLE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=242]">
		<p>TRANSLATION OF TITLE BY CATALOGING AGENCY</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Title:
	...
	<xsl:template match="marc:datafield[@tag=247]">
		<p>FORMER TITLE OR TITLE VARIATIONS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Title proper/short title:
	...
	<xsl:template match="marc:datafield[@tag=254]">
		<p>MUSICAL PRESENTATION STATEMENT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=255]">
		<p>CARTOGRAPHIC MATHEMATICAL DATA</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Statement of scale:
	...
	<xsl:template match="marc:datafield[@tag=256]">
		<p>COMPUTER FILE CHARACTERISTICS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=257]">
		<p>COUNTRY OF PRODUCING ENTITY FOR ARCHIVAL FILMS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=260]">
		<p>PUBLICATION, DISTRIBUTION, ETC. (IMPRINT)</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=263]">
		<p>PROJECTED PUBLICATION DATE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=265]">
		<p>SOURCE FOR ACQUISITION/SUBSCRIPTION ADDRESS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=301]">
		<p>PHYSICAL DESCRIPTION FOR FILMS (PRE-AACR 2)</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Extent of item:
	...
	<xsl:template match="marc:datafield[@tag=305]">
		<p>PHYSICAL DESCRIPTION FOR SOUND RECORDINGS (Pre-AACR 2)</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Extent:
	...
	<xsl:template match="marc:datafield[@tag=308]">
		<p>PHYSICAL DESCRIPTION FOR FILMS (ARCHIVAL)</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Number of reels:
	...
	<xsl:template match="marc:datafield[@tag=310]">
		<p>CURRENT PUBLICATION FREQUENCY</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=311]">
		<p>MEETING ROOMS AND FACILITIES AVAILABLE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=321]">
		<p>FORMER PUBLICATION FREQUENCY</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=351]">
		<p>ORGANIZATION AND ARRANGEMENT OF MATERIALS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Organization:
	...
	<xsl:template match="marc:datafield[@tag=352]">
		<p>DIGITAL GRAPHIC REPRESENTATION</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=355]">
		<p>SECURITY CLASSIFICATION CONTROL</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=357]">
		<p>ORIGINATOR DISSEMINATION CONTROL</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=362]">
		<p>DATES OF PUBLICATION AND/OR SEQUENTIAL DESIGNATION</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=440]">
		<p>SERIES STATEMENT/ADDED ENTRY--TITLE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Title:
	...
	<xsl:template match="marc:datafield[@tag=503]">
		<p>BIBLIOGRAPHIC HISTORY NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=506]">
		<p>RESTRICTIONS ON ACCESS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='3']">
				<li>
					Materials specified:
	...
	<xsl:template match="marc:datafield[@tag=507]">
		<p>SCALE NOTE FOR GRAPHIC MATERIAL</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=508]">
		<p>CREATION/PRODUCTION CREDITS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=511]">
		<p>PARTICIPANT OR PERFORMER NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=512]">
		<p>EARLIER OR LATER VOLUMES SEPARATELY CATALOGED NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=513]">
		<p>TYPE OF REPORT AND PERIOD COVERED NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Type of report:
	...
	<xsl:template match="marc:datafield[@tag=515]">
		<p>NUMBERING PECULIARITIES NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=516]">
		<p>TYPE OF COMPUTER FILE OR DATA NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=517]">
		<p>CATEGORIES OF FILMS NOTE (ARCHIVAL)</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Different formats:
	...
	<xsl:template match="marc:datafield[@tag=518]">
		<p>DATE/TIME AND PLACE OF AN EVENT NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=523]">
		<p>TIME PERIOD OF CONTENT NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=524]">
		<p>PREFERRED CITATION OF DESCRIBED MATERIALS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=526]">
		<p>STUDY PROGRAM INFORMATION NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=530]">
		<p>ADDITIONAL PHYSICAL FORM AVAILABLE NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=531]">
		<p>ELIGIBILITY, FEES, PROCEDURES NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Eligibility:
	...
	<xsl:template match="marc:datafield[@tag=535]">
		<p>LOCATION OF ORIGINALS/DUPLICATES NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Custodian:
	...
	<xsl:template match="marc:datafield[@tag=540]">
		<p>TERMS GOVERNING USE AND REPRODUCTION NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=543]">
		<p>SOLICITATION INFORMATION NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=544]">
		<p>LOCATION OF OTHER ARCHIVAL MATERIALS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='3']">
				<li>
					Materials specified:
	...
	<xsl:template match="marc:datafield[@tag=545]">
		<p>BIOGRAPHICAL OR HISTORICAL DATA</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=547]">
		<p>FORMER TITLE COMPLEXITY NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=552]">
		<p>ENTITY AND ATTRIBUTE INFORMATION NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=555]">
		<p>CUMULATIVE INDEX/FINDING AIDS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=556]">
		<p>INFORMATION ABOUT DOCUMENTATION NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=561]">
		<p>OWNERSHIP AND CUSTODIAL HISTORY</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					History:
	...
	<xsl:template match="marc:datafield[@tag=562]">
		<p>COPY AND VERSION IDENTIFICATION NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=565]">
		<p>CASE FILE CHARACTERISTICS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=572]">
		<p>AFFILIATION AND OTHER RELATIONSHIPS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=574]">
		<p>TRANSPORTATION AND DIRECTIONS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=575]">
		<p>ACCOMMODATIONS FOR THE DISABLED NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=580]">
		<p>LINKING ENTRY COMPLEXITY NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=581]">
		<p>PUBLICATIONS ABOUT DESCRIBED MATERIALS NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=582]">
		<p>RELATED COMPUTER FILES NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=584]">
		<p>ACCUMULATION AND FREQUENCY OF USE NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Accumulation:
	...
	<xsl:template match="marc:datafield[@tag=587]">
		<p>OTHER INFORMATION AVAILABLE NOTE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=600]">
		<p>SUBJECT ADDED ENTRY--PERSONAL NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='3']">
				<li>
					Materials specified:
	...
	<xsl:template match="marc:datafield[@tag=610]">
		<p>SUBJECT ADDED ENTRY--CORPORATE NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Corporate name or jurisdiction name as entry element:
	...
	<xsl:template match="marc:datafield[@tag=611]">
		<p>SUBJECT ADDED ENTRY--MEETING NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Meeting name or jurisdiction name as entry element:
	...
	<xsl:template match="marc:datafield[@tag=630]">
		<p>SUBJECT ADDED ENTRY--UNIFORM TITLE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Uniform title:
	...
	<xsl:template match="marc:datafield[@tag=650]">
		<p>SUBJECT ADDED ENTRY--TOPICAL TERM</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=651]">
		<p>SUBJECT ADDED ENTRY--GEOGRAPHIC NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Geographic name:
	...
	<xsl:template match="marc:datafield[@tag=652]">
		<p>SUBJECT ADDED ENTRY--REVERSED GEOGRAPHIC</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=654]">
		<p>SUBJECT ADDED ENTRY--FACETED TOPICAL TERMS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Focus term:
	...
	<xsl:template match="marc:datafield[@tag=655]">
		<p>INDEX TERM--GENRE/FORM/PHYSICAL CHARACTERISTICS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=658]">
		<p>INDEX TERM--CURRICULUM OBJECTIVE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=705]">
		<p>ADDED ENTRY--PERSONAL NAME (PERFORMER)</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Personal name:
	...
	<xsl:template match="marc:datafield[@tag=710]">
		<p>ADDED ENTRY--CORPORATE NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Corporate name or jurisdiction name as entry element:
	...
	<xsl:template match="marc:datafield[@tag=715]">
		<p>ADDED ENTRY--CORPORATE NAME-PERFORMING GROUP</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=720]">
		<p>ADDED ENTRY--UNCONTROLLED NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Name:
	...
	<xsl:template match="marc:datafield[@tag=740]">
		<p>ADDED ENTRY--UNCONTROLLED RELATED/ANALYTICAL TITLE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=752]">
		<p>ADDED ENTRY--HIERARCHICAL PLACE NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Country:
	...
	<xsl:template match="marc:datafield[@tag=753]">
		<p>SYSTEM DETAILS ACCESS TO COMPUTER FILES</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=754]">
		<p>ADDED ENTRY--TAXONOMIC IDENTIFICATION</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=755]">
		<p>ADDED ENTRY--PHYSICAL CHARACTERISTICS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Access term:
	...
	<xsl:template match="marc:datafield[@tag=770]">
		<p>SUPPLEMENT/SPECIAL ISSUE ENTRY</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Main entry heading:
	...
	<xsl:template match="marc:datafield[@tag=776]">
		<p>ADDITIONAL PHYSICAL FORM ENTRY</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Main entry heading:
	...
	<xsl:template match="marc:datafield[@tag=787]">
		<p>NONSPECIFIC RELATIONSHIP ENTRY</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Main entry heading:
	...
	<xsl:template match="marc:datafield[@tag=800]">
		<p>SERIES ADDED ENTRY--PERSONAL NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=810]">
		<p>SERIES ADDED ENTRY--CORPORATE NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Corporate name or jurisdiction name as entry element:
	...
	<xsl:template match="marc:datafield[@tag=811]">
		<p>SERIES ADDED ENTRY--MEETING NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Meeting name or jurisdiction name as entry element:
	...
	<xsl:template match="marc:datafield[@tag=830]">
		<p>SERIES ADDED ENTRY--UNIFORM TITLE</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Uniform title:
	...
	<xsl:template match="marc:datafield[@tag=841]">
		<p>HOLDINGS CODED DATA VALUES</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Type of record:
	...
	<xsl:template match="marc:datafield[@tag=842]">
		<p>TEXTUAL PHYSICAL FORM DESIGNATOR</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=853]">
		<p>CAPTIONS AND PATTERN--BASIC BIBLIOGRAPHIC UNIT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=854]">
		<p>CAPTIONS AND PATTERN--SUPPLEMENTARY MATERIAL</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					First level of enumeration:
	...
	<xsl:template match="marc:datafield[@tag=855]">
		<p>CAPTIONS AND PATTERN--INDEXES</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					First level of enumeration:
	...
	<xsl:template match="marc:datafield[@tag=856]">
		<p>ELECTRONIC LOCATION AND ACCESS</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=863]">
		<p>ENUMERATION AND CHRONOLOGY--BASIC BIBLIOGRAPHIC UNIT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					First level of enumeration:
	...
	<xsl:template match="marc:datafield[@tag=864]">
		<p>ENUMERATION AND CHRONOLOGY--SUPPLEMENTARY MATERIAL</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					First level of enumeration:
	...
	<xsl:template match="marc:datafield[@tag=865]">
		<p>ENUMERATION AND CHRONOLOGY--INDEXES</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					First level of enumeration:
	...
	<xsl:template match="marc:datafield[@tag=866]">
		<p>TEXTUAL HOLDINGS--BASIC BIBLIOGRAPHIC UNIT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Textual string:
	...
	<xsl:template match="marc:datafield[@tag=867]">
		<p>TEXTUAL HOLDINGS--SUPPLEMENTARY MATERIAL</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Textual holdings:
	...
	<xsl:template match="marc:datafield[@tag=872]">
		<p>VARIANT CONFERENCE OR MEETING NAME</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Meeting name or jurisdiction name as entry element:
	...
	<xsl:template match="marc:datafield[@tag=873]">
		<p>VARIANT UNIFORM TITLE HEADING</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Uniform title:
	...
	<xsl:template match="marc:datafield[@tag=876]">
		<p>ITEM INFORMATION--BASIC BIBLIOGRAPHIC UNIT</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
	...
	<xsl:template match="marc:datafield[@tag=877]">
		<p>ITEM INFORMATION--SUPPLEMENTARY MATERIAL</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
					Internal item number:
	...
	<xsl:template match="marc:datafield[@tag=880]">
		<p>ALTERNATE GRAPHIC REPRESENTATION</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='6']">
				<li>
					Linkage:
	...
	<xsl:template match="marc:datafield[@tag=886]">
		<p>FOREIGN MARC INFORMATION FIELD</p>
		<ul>
			<xsl:for-each select="marc:subfield[@code='a']">
				<li>
